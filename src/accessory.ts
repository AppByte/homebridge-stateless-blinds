...
class StatelessBlindAccessory implements AccessoryPlugin {
    ...
    constructor(log: Logging, config: AccessoryConfig, api: API) {
        ...
        this.upService.getCharacteristic(this.api.hap.Characteristic.On).onGet(this.handleOnUpGet.bind(this)).onSet(this.handleOnUpSet.bind(this));
        this.downService.getCharacteristic(this.api.hap.Characteristic.On).onGet(this.handleOnDownGet.bind(this)).onSet(this.handleOnDownSet.bind(this));
